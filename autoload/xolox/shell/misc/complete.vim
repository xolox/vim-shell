...
function! xolox#shell#misc#complete#keywords(arglead, cmdline, cursorpos)
  ...
  "
  "     :command -nargs=* -complete=customlist,xolox#shell#misc#complete#keywords MyCmd call s:MyCmd(<f-args>)
  let words = {}
