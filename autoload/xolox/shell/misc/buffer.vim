...
function! xolox#shell#misc#buffer#is_empty() " {{{1
...
function! xolox#shell#misc#buffer#prepare(...) " {{{1
  ...
  for bufnr in tabpagebuflist()
    if xolox#shell#misc#path#equals(options['path'], bufname(bufnr))
  ...
  if !(found || xolox#shell#misc#buffer#is_empty())
    vsplit
  endif
  ...
  call xolox#shell#misc#buffer#unlock()
  silent %delete
endfunction

function! xolox#shell#misc#buffer#lock() " {{{1
  " Lock a special buffer so that its contents can no longer be edited.
  setlocal readonly nomodifiable nomodified
endfunction

function! xolox#shell#misc#buffer#unlock() " {{{1
